...
--
-- Database: `tritiyo_chakariaummdm2`
--
...
(1357, '', '', 0, '$2y$08$t9eZY2D9on7Qa44eDk6MYOdP823b0diJ/ZiXHdf0OU26UIdRhuRZm', NULL, 'skydotint@gmail.com', NULL, NULL, NULL, 'hKN2ytzPvIRI60ESN9imMe', 1268889823, 1477842622, 1, 'Tritiyo', 'Limited', 'Tritiyo Limited', 'Tritiyo Limited', 'Badruzzaman Khan', 'Badruzzaman Khan', 'Shahinazzaman Khan', 'Shahinazzaman Khan', 'Tritiyo Limited', '01821660066'),
...
--
ALTER TABLE `users`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106224;
